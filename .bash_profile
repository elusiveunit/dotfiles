...
if is_mac; then
	...
	export PATH="$GOPATH/bin:$DEVELOPMENTPATH/flutter/bin:$HOME/.pub-cache/bin:$ANDROID_HOME/emulator:$ANDROID_HOME/tools:$ANDROID_HOME/platform-tools:/usr/local/sbin:~/.fastlane/bin":$PATH
