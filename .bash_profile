...
if is_mac; then
	...
	export PATH="$DOTFILESPATH/bin:$GOPATH/bin:$DEVELOPMENTPATH/flutter/bin:$ANDROID_HOME/tools:$ANDROID_HOME/platform-tools:/usr/local/sbin:$DEVOPSPATH/bin:~/.fastlane/bin":$PATH
